...
private void addButtonToTable() throws SQLException {
            ...
            public TableCell<Job, Void> call(final TableColumn<Job, Void> param) {
                final TableCell<Job, Void> cell = new TableCell<Job, Void>() {
...

                    {
                            ...
                            Image del = new Image(getClass().getResourceAsStream("images/del.png"));
                   
        
                           Image upd = new Image(getClass().getResourceAsStream("images/upd.png"));
                        ...
                        update.setOnAction((ActionEvent event) -> {
                            ...
                            try {
                               ...
                               SessionJob.getInstace(jo.getId());
                                ...
                                page2 = FXMLLoader.load(getClass().getResource("UpdateJob.fxml"));
    ...
    private void add(ActionEvent event) throws IOException {
        ...
        Scene scene = new Scene(FXMLLoader.load(getClass().getResource("AddJob.fxml")));
