        ...
        if (token != 0 && !this.mail.getText().isEmpty()) {
            try {
                ...
                System.out.println("code was sent  successfully");
                   ...
                   esprit.recrutini.services.Session.getInstace(this.mail.getText());
                       JOptionPane.showMessageDialog(null,"a verification code was sent to your email");
                              Node node = (Node) event.getSource();
        Stage stage = (Stage) node.getScene().getWindow();
        stage.close();

        Scene scene = new Scene(FXMLLoader.load(getClass().getResource("/esprit/recrutini/view/ResetPassword.fxml")));
