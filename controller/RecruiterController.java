...
public class RecruiterController implements Initializable {
    ...
    @FXML
    private void tablerecruiter_event(MouseEvent event) {
    ...
    public void show_recruiter() {
        ...
        try {
            ...
            result = st.executeQuery();
            while (result.next()) {
                data.add(new Recruiter(result.getString("field_id"), result.getString("name"), result.getString("email"), result.getString("description"), result.getString("password"), result.getString("address"), result.getString("phone_number")));
            }
        } catch (SQLException e) {
            e.printStackTrace();
        }
       ...
       // recruiter_address.setCellValueFactory(new PropertyValueFactory<Recruiter, String>("address"));
        ...
        //recruiter_phone_number.setCellValueFactory(new PropertyValueFactory<Recruiter, Integer>("phone_number"));
    ...
    @FXML
    private void add_recruiter(MouseEvent event) {
    ...
    @FXML
    private void edit_recruiter(MouseEvent event) {
        String name = txt_Name.getText();
        String address = txt_address.getText();
        String description = txt_description.getText();
        String phone_number = txt_phone_number.getText();
    ...
    @FXML
    private void delete_recruiter(MouseEvent event) {
    ...
    @FXML
    private void search_recruiter(MouseEvent event) {
